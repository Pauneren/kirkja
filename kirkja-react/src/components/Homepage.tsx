...
const Homepage: React.FC = () => {
  ...
  return (
    ...
    <img src="/kirkja/images/olafsvikurkirkja.jpg" alt="Olafskirkja" className="church-image" />
    <h4>Olafskirkja</h4>
    <p>Ólafsvík</p>
    ...
    <div className="church-card">
    <img src="/kirkja/images/ingjaldsholkirkja.jpg" alt="Ingjalsholskirkja" className="church-image" />
